...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // create the studentAdapter with students and set it to the listview
    ...
    public void openSong(Song song) {
        Intent startSong = new Intent(this, PlayMusicActivity.class);
        startSong.putExtra("path", song.getPath());
        startSong.putExtra("title", song.getTitle());
        startActivityForResult(startSong, REQUEST_CODE);
    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://studio6ty9.musicapp/http/host/path")
        );
